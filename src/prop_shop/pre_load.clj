...
(defn load-data
  ...
  (let [organization {:name "Mammoth Erection" :type :organization :uuid #uuid "568c78c0-fe6c-4737-8586-5bdee73438bb"}
        user1 {:name "Dan" :type :user :uuid #uuid "568c78d7-09ad-4730-b468-7e2026e559cf"}
        user2 {:name "Justin" :type :user :uuid #uuid "568c7cf8-1eb5-4099-aa65-70367594a920"}]
    (if-not (b/get-entity-by-uuid (:uuid organization)) (b/add-entity organization))
